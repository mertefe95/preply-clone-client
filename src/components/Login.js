          ...
          <div className="login-form">
            <div className="login-inner-first">
              ...
              <div className="h1-right">
                <Link className="sign-up-student" tabIndex="1" data-go-action="LoginPage" data-ga-label="Sign_up_as_student" data-qa-id="sign-up-student-link">
                  <span>Sign up as a student</span>
                </Link>
                <span className="sign-up-divider">or</span>
                <Link className="sign-up-tutor" tabIndex="1" data-dwh-event-name="tutor-acquisition" data-dwh-action="become_a_tutor_sign_up_page" data-ga-action="LoginPage" data-ga-label="Sign_up_as_tutor">
