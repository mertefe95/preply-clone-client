  ...
  return (
    ...
    <div className="first-half-nav">
      ...
      <ul className="leftside-links">
        <li className="header-li"><Link className="header-link">Find tutors</Link></li>
        <li className="header-li"><Link className="header-link">Enterprise</Link></li>
      ...
      <div className="hamburger-div"><svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 .78H0v2h19v-2zM19 7.78H0v2h19v-2zM0 14.78h19v2H0v-2z" fill="#B5BEC5"></path></svg></div>
